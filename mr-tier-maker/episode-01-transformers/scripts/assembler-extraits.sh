...
#   31986407345/   12 extraits, les requetes reecrites en repliques (NOUVELLE)
#   31986855720/    4 extraits, 2e passe sur 017 074 091 101      (NOUVELLE)
#
...
for r in 31951727721 31970533637 31974243565 31986407345 31986855720; do
