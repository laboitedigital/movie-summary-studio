# -*- coding: utf-8 -*-
"""Reporte les plans du SRT master sur la voix off de reference.
...
print("\n%d plans remappes -> voix/plans-remappes.json" % len(out))
print("duree de reference : %.2f s" % SEG[-1]['nouveau_fin'])
